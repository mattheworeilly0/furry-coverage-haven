          ...
          ease: [0.22, 1, 0.36, 1]
            ...
            <div className="mt-12 flex items-center gap-6">
              <div className="flex -space-x-4">
                <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=70&h=70&auto=format&fit=crop" alt="Customer" className="w-10 h-10 rounded-full border-2 border-white object-cover" />
                <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=70&h=70&auto=format&fit=crop" alt="Customer" className="w-10 h-10 rounded-full border-2 border-white object-cover" />
                <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=70&h=70&auto=format&fit=crop" alt="Customer" className="w-10 h-10 rounded-full border-2 border-white object-cover" />
              </div>
              <div>
                <div className="flex items-center gap-1">
                  {[...Array(5)].map((_, i) => <svg key={i} className="w-5 h-5 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
          ...
          ease: [0.22, 1, 0.36, 1]
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-3xl overflow-hidden">
                <img alt="Happy cat being held" className="w-full h-full object-cover" src="/lovable-uploads/fcf688e3-ef7d-45f3-a7ff-7f5adf578c49.jpg" />
              </div>
